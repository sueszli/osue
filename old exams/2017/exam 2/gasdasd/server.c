...
void task_1a(void)
{
    ...
    if(shmfd<0){
        error_exit("FAIL shmfd");
    }

    if(ftruncate(shmfd, sizeof(shm_data_t))==-1){
        error_exit("ftruncate fail");
    }
